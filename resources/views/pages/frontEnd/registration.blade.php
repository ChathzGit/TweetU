...
@section('content')
    ...
    <div class="container-fluid" ng-controller="userAccountController">
            ...
            <div class="row m-t-20 well bg-opc-65">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="col-sm-12 text-right">
                        <button type="button" class="btn btn-twitter-custom p-l-30 p-r-30" id="btn-save" ng-click="save(id)"
