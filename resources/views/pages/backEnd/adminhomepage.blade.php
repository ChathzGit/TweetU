...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Tweet-U Admin</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
...
<!---------------------- RIGHT SIDE ------------------------------------------------------------------------------>
            <div class="col-lg-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-industry fa-fw"></i> Graph Specs
                    </div>
                    <!-- /.panel-heading -->
                    <div class="panel-body">
                        <div class="list-group">
                            <label for="sc_time">Time Range</label>
                            <select id="sc_time" class="form-control">
                                <option>This week</option>
                                <option>This month</option>
                                <option>Past three months</option>
                                <option>This year</option>
                                <option>Past three years</option>
                            </select>
                        </div>
                        <!-- /.list-group -->
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i> Twitter Analytics
                    </div>
                    <div class="panel-body">
